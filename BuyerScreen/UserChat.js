...
import {collection, doc, addDoc, query, getDocs, orderBy, deleteDoc, updateDoc} from "firebase/firestore";
...
export default function UserChat(params) {
    ...
    const sendMessage = async () => {
        ...
        if (message.trim() !== '') {
            ...
            setMessages([...messages, {id: messages.length.toString(), ...messageObj}]);
            setMessage('');
        }
    };
        ...
        return (
            <View style={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        }
                        {
                            currentOrder?.status === 'uploaded' && (
                                <TouchableOpacity style={styles.completeButton} onPress={() => onMarkComplete('completed')}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => (
                        <View
                            style={item.fromMe !== data?.userId ? styles.myMessageContainer : styles.otherMessageContainer}>
