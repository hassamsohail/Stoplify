    ...
    getDocs(collection(firestore, "Bids"))
      .then((querySnapshot) => {
        ...
        querySnapshot.forEach((doc1) => {
          if (doc1?.data()?.project_id === projectId) {
                      ...
                      {isloading ? (
                        ...
                        <>
                          <TouchableOpacity
                            disabled={isloading}
                            onPress={() => {
                              AllocateProject(item?.bid_id, "active");
                            }}
                          >
                            <View
                              style={{
                          ...
                          <TouchableOpacity
                            disabled={isloading}
                            onPress={() => {
                              AllocateProject(item?.bid_id, "rejected");
                            }}
                          >
                            <View
                              style={{
